        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse text-center" id="navbar">
                    ...
                    <a href="<?= base_url() ?><?php if (session()->get("isLoggedIn")): ?>mypanel/dashboard<?php else: ?>auth/register<?php endif; ?>" class="btn btn-primary ml-lg-3 primary-shadow"><?= session()->get("isLoggedIn") ? "Dashboard" : "Sign Up" ?>
                    </a>
                </div>
            </nav>
        </div>
